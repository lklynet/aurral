...
| `MALLOC_CONF` | jemalloc page-decay settings. The Docker image defaults to `dirty_decay_ms:1000,muzzy_decay_ms:1000` so freed native image buffers return to the operating system sooner. |
