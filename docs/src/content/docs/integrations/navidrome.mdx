...
Aurral-managed Navidrome playlists are public. New playlists are marked public after creation, and the next sync repairs existing private Aurral playlists. Every Navidrome account can see and play them, while playlist changes remain owned by the configured Navidrome account.
