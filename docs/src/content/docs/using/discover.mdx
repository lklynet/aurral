...
When you add a NewsAPI key in **Settings > Connect**, Discover shows recent music stories about artists in your Lidarr library. Aurral searches for the exact artist name in article titles with music-related terms, then removes headlines without the artist name.
