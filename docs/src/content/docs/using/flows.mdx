...
playback from that flow in Aurral's built-in player. Turn it off to keep the
flow out of future recommendations and connected scrobblers. Aurral keeps plays
