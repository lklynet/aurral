...
Right-click an available Aurral-owned track in a flow to **Re-search** it for a
replacement recording. The current file stays available until the replacement
passes validation.
