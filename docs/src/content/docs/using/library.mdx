...
Use the **Refresh** button in Library when you need to check immediately. The
button starts a scan, waits for it to finish, and reloads the page from the
updated canonical records. The scheduled scan remains as a fallback and runs
every 15 minutes.
